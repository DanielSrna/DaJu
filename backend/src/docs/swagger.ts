    ...
    components: {
      ...
      schemas: {
        ...
        Plantilla: {
          ...
          properties: {
            id: { type: "string" },
            nombre: { type: "string", example: "Plantilla Reservas" },
            slug: { type: "string", example: "reservas" },
            plataforma: { type: "string", example: "Reservas" },
            descripcion: { type: "string" },
            precio: { type: "number", example: 299 },
            moneda: { type: "string", example: "USD" },
            vistasIncluidas: { type: "number", example: 5 },
            soporteMeses: { type: "number", example: 3 },
            diasEntrega: { type: "number", example: 20 },
            features: { type: "array", items: { type: "string" } },
            imagen: {
              type: "object",
              properties: {
        ...
        Servicio: {
          ...
          properties: {
            id: { type: "string" },
            nombre: { type: "string", example: "Auditoría de código" },
            slug: { type: "string", example: "auditoria-codigo" },
            categoria: {
              type: "string",
            ...
            moneda: { type: "string", example: "USD" },
            duracionMin: { type: "number", example: 60 },
        ...
        ServicioInput: {
          type: "object",
          required: ["nombre", "slug", "categoria", "descripcion", "precio"],
          properties: {
            nombre: { type: "string", example: "Auditoría de código" },
            slug: { type: "string", example: "auditoria-codigo" },
            categoria: {
        ...
        Pago: {
          ...
          properties: {
            ...
            productoSlug: {
              type: "string",
              example: "reservas",
              description: "Slug del ítem comprado (plantilla/servicio)",
            },
            cantidad: {
              type: "number",
              example: 1,
              description: "Sesiones compradas (solo servicios)",
            },
            descripcion: { type: "string" },
